SHELL=cmd
STRIPE_SECRET=sk_test_51Q0sPcP7IGgOy6Pqo6007XDThvJKWIWzWNjAFt81PWlncObb2g6Vy5gNeG07T5IaQALUs1NEUMDoMPC3bG4qXIPH004ohMZGSW
STRIPE_KEY=pk_test_51Q0sPcP7IGgOy6PqCxIYI5HuVzndTCNduptDTkNxZI5AJbHCfNWTdMT4vihVmzaAmXpV00cIkzvmo3HvswMgTOeP006gCBS6ho
GOSTRIPE_PORT=4000
API_PORT=4001
...
start_front: build_front
	...
	set STRIPE_KEY=${STRIPE_KEY}&& set STRIPE_SECRET=${STRIPE_SECRET}&& set DSN=${DSN}&& start /B .\dist\gostripe.exe
